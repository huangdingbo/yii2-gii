...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'dsj\gii\controllers';
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'dsj\gii\console\GenerateController',
    ...
    {
        return [
            'api' => ['class' => 'dsj\gii\generators\api\Generator'],
            'model' => ['class' => 'dsj\gii\generators\model\Generator'],
            'crud' => ['class' => 'dsj\gii\generators\crud\Generator'],
            'controller' => ['class' => 'dsj\gii\generators\controller\Generator'],
            'form' => ['class' => 'dsj\gii\generators\form\Generator'],
            'module' => ['class' => 'dsj\gii\generators\module\Generator'],
            'extension' => ['class' => 'dsj\gii\generators\extension\Generator'],
        ];
    }
    ...
    {
        $packageInfo = Json::decode(file_get_contents(__DIR__ . DIRECTORY_SEPARATOR));
