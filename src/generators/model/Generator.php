...
namespace dsj\gii\generators\model;
...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return '该生成器为指定的数据库表生成ActiveRecord类。';
    }
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            ...
            'generateRelationsFromCurrentSchema' => '从当前模式生成关系',
            'generateLabelsFromComments' => '从DB注释生成标签',
            'generateQuery' => '生成ActiveQuery',
            'queryNs' => 'ActiveQuery名称空间',
            'queryClass' => 'ActiveQuery类',
            'queryBaseClass' => 'ActiveQuery基类',
            'useSchemaName' => '使用模式名称',
        ]);
    }
