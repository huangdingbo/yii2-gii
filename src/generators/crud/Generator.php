...
namespace dsj\gii\generators\crud;
...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return '此生成器生成实现CRUD(创建、读取、更新、删除)的控制器和视图指定数据模型的操作。';
    }
    ...
    {   
        return array_merge(parent::rules(), [
            ...
            [['indexWidgetType'], 'in', 'range' => ['grid', 'list', 'responsiveGrid']],
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            ...
            'indexWidgetType' => '用于索引页的小部件',
            'searchModelClass' => '搜索模型类',
            'enablePjax' => '使用Pjax',
        ]);
    }
